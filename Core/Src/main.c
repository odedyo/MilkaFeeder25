...
#define INIT_SECOND 0x45
#define INIT_YEAR 0x24
#define INIT_MONTH RTC_MONTH_DECEMBER
#define INIT_DAY 0x18

#define DEBOUNCE_DELAY 3 // number of consecutive checks over ~30ms if sampling every 10ms
